...
class Mailer
{
    ...
    public static function ValidateAddress($address)
    {
        if (function_exists('filter_var')) { //Introduced in PHP 5.2
            ...
            //return preg_match(\Tk\Validator::REG_EMAIL, $address);
    ...
    protected function doCallback($isSent, $to, $cc, $bcc, $subject, $body)
    {
        if (!empty($this->action_function)) {
            if ((is_string($this->action_function) && function_exists($this->action_function)) ||
                (is_array($this->action_function) && method_exists($this->action_function[0], $this->action_function[1])) ) 
            {
