 ...
 */
class Filesystem extends \Tk\Object implements Iface
{
    /**
     * @var string
     */
    ...
    {
        if (!$cachePath) {
            //$cachePath = ini_get('session.save_path');    // Session cache files
            $cachePath = $this->getConfig()->getDataPath().'/sysCache';
        }
    ...
    {
        return \Tk\Path::rmdir($this->cachePath);
    }
